...
-- 1. "Category"
INSERT INTO "Category" (id, name, slug, "parentId") VALUES (1, 'Men', 'men', NULL) ON CONFLICT DO NOTHING;
INSERT INTO "Category" (id, name, slug, "parentId") VALUES (2, 'Women', 'women', NULL) ON CONFLICT DO NOTHING;
INSERT INTO "Category" (id, name, slug, "parentId") VALUES (3, 'Accessories', 'accessories', NULL) ON CONFLICT DO NOTHING;
INSERT INTO "Category" (id, name, slug, "parentId") VALUES (4, 'Men's Tops', 'men-tops', 1) ON CONFLICT DO NOTHING;
INSERT INTO "Category" (id, name, slug, "parentId") VALUES (5, 'Men's Bottoms', 'men-bottoms', 1) ON CONFLICT DO NOTHING;
INSERT INTO "Category" (id, name, slug, "parentId") VALUES (6, 'Dresses', 'dresses', 2) ON CONFLICT DO NOTHING;
INSERT INTO "Category" (id, name, slug, "parentId") VALUES (7, 'Women's Tops', 'women-tops', 2) ON CONFLICT DO NOTHING;
INSERT INTO "Category" (id, name, slug, "parentId") VALUES (8, 'Bags', 'bags', 3) ON CONFLICT DO NOTHING;
INSERT INTO "Category" (id, name, slug, "parentId") VALUES (9, 'Footwear', 'footwear', 3) ON CONFLICT DO NOTHING;
SELECT setval('"Category_id_seq"', 9, true);

-- 2. "Product" AND VARIANTS
INSERT INTO "Product" (id, name, slug, description, thumbnail, "originalPrice", price, "isActive", rating, "reviewCount") 
...
INSERT INTO "ProductVariant" ("productId", color, size, sku, image, stock)
        VALUES (1, 'Black', 'M', 'FLO-001-BLA-M', 'https://placehold.co/400x400?text=Black+M', 49)
        ON CONFLICT ("productId", color, size) DO NOTHING;
INSERT INTO "ProductVariant" ("productId", color, size, sku, image, stock)
